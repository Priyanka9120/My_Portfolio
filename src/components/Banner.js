...
import Image from '../assets/AVTAR2.png';
        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12 '>
          <div className='flex-1 text-center font-secondary lg:text-left'>
            ...
            <motion.div className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0'>
              ...
              <a href='https://www.linkedin.com/in/priyanka9120/'>
                <FaLinkedin />
              </a>

              <a href='https://github.com/Priyanka9120'>
                <FaGithub />
              </a>

              <a href='mailto:priyanka912066@gmail.com'>
                <FiMail />
              </a>
